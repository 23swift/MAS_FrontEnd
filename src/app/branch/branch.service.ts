...
{
  template: '<span class="mat-subheading-1">Payment Method For Credit Facility:</span>',
},
//mandatory checkbox
{
  fieldGroupClassName: 'display-flex',
...
{
  template: '<span class="mat-subheading-1">With Installed Electronic Cash Register (ECR)</span>',
},
//one column withECR (true false) 
{
  fieldGroupClassName: 'display-flex',
  fieldGroup: [{
    type: 'checkbox',
...

            {
...

              {
                ...
                fieldGroup: [{
                  ...
                  placeholder: 'Default Transaction Source'
                  }      
                },
                {
                  className: 'flex-1',
